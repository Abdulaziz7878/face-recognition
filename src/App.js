...
class App extends Component {
  ...
  loadUser = (user) => {
    const { id, name, email, entries, joinedDate } = user;
    this.setState({
      user: {
        id: id,
        name: name,
  ...
  calaulateFaceLocation = (topRow, leftCol, bottomRow, rightCol) => {
  ...
  onSubmit = () => {
    ...
    const PAT = "d88574e16e334e52a9343dc120ab1f17";
    // Specify the correct user_id/app_id pairings
    // Since you're making inferences outside your app's scope
    const USER_ID = "4gjibvxwgjt7";
      ...
      .then((result) => {
        ...
        if (regions) {
          const boxes = regions.map((region) => {
            ...
            return this.calaulateFaceLocation(
              topRow,
              leftCol,
              bottomRow,
              rightCol
